...
/// Other use-case accounting screen — independent copy so it can diverge later.
class OthersAccountingScreen extends StatefulWidget {
  const OthersAccountingScreen({Key? key}) : super(key: key);

  @override
  State<OthersAccountingScreen> createState() => _OthersAccountingScreenState();
}

class _OthersAccountingScreenState extends State<OthersAccountingScreen> {
