...
/// Institute/Organization accounting screen — independent copy so it can diverge later.
class InstituteAccountingScreen extends StatefulWidget {
  const InstituteAccountingScreen({Key? key}) : super(key: key);

  @override
  State<InstituteAccountingScreen> createState() =>
      _InstituteAccountingScreenState();
}

class _InstituteAccountingScreenState extends State<InstituteAccountingScreen> {
